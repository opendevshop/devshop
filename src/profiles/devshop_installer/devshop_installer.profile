 ...
 */
function devshop_installer_install_tasks(): array {
 ...
 */
function devshop_installer_install_tasks_alter(array &$tasks, array $install_state): void {
 ...
 */
function devshop_installer_form_alter(array &$form, FormStateInterface $form_state, string $form_id): void {
 ...
 */
function devshop_installer_form_install_configure_form_alter(array &$form): void {
