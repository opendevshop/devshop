...
namespace DevShop\Component\GitHubDeployments\Command;
 ...
 */
class GitHubDeploymentComposerCommand extends BaseCommand
{
  ...
  {
    $this->command = new GitHubDeploymentConsoleCommand();
